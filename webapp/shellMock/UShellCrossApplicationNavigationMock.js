sap.ui.define(
  ...
  function (BaseObject, Factory, jQuery) {
    ...
    var UShellCrossApplicationNavigationMock = BaseObject.extend(
      "smartchart.shellMock.UShellCrossApplicationNavigationMock" /** @lends sap.ui.demo.smartControls.shellMock.UShellCrossApplicationNavigationMock.prototype */,
      {}
    );

    UShellCrossApplicationNavigationMock.getServiceReal = Factory.getService;

    UShellCrossApplicationNavigationMock.mockUShellServices = function (
      oSetting
    ) {
      Factory.getService = function (sServiceName) {
        switch (sServiceName) {
          ...
          default:
            return UShellCrossApplicationNavigationMock.getServiceReal(
              sServiceName
            );
        }
      };
