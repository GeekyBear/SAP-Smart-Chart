					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Smart Chart",
									"targetURL": "#smartchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartchart-display": {
								"semanticObject": "smartchart",
								"action": "display",
								"description": "A Smart Chart application.",
								"title": "App Smart Chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartchart",
									"url": sap.ui.require.toUrl("smartchart")
								}
							}
						}
					}
